...
urlpatterns = [
    ...
    path('<slug:tier_slug>/lessons/<int:lesson_order>/exercise/submit/', views.submit_exercise_attempt, name='exercise_submit'),
    path('<slug:tier_slug>/lessons/<int:lesson_order>/exercise/preview/', views.exercise_preview, name='exercise_preview'),
